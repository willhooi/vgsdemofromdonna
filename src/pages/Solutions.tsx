...
/* Phones visual */
.vg-sol .ze2-phones{position:relative;display:flex;justify-content:center;align-items:center;padding:30px 20px 30px 40px;min-height:360px;overflow:hidden}
.vg-sol .ze2-phones-img{width:100%;max-width:520px;height:auto;object-fit:contain;display:block;filter:drop-shadow(0 20px 40px rgba(20,40,20,.18))}

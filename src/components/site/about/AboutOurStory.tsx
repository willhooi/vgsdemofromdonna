...
const milestones: Milestone[] = [
  ...
  },
  {
    year: "2008–2018",
    title: "Growth years",
    body: "One of Vietnam's leading SMS Brandname providers — Samsung E-warranty (2008), LG (2017), #1 SMS in e-commerce (2018), serving banks, airlines, retailers and global brands.",
  },
  {
    year: "Year TBC",
    tbc: true,

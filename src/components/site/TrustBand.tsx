...
const stats = [
  ...
  },
  {
    ...
    target: 8000000,
    suffix: "+",
    label: "Messages delivered every day across Vietnam’s most popular platforms.",
  },
];
...
const BRANDS_ROW_2: Brand[] = [
  { name: "Vietnam Airlines", logo: vietnamAirlinesLogo, scale: 1.35 },
  { name: "Traveloka", logo: travelokaLogo, scale: 1.0 },
  { name: "Agoda", logo: agodaLogo, scale: 1.2 },
  { name: "Grab", logo: grabLogo, scale: 1.4 },
  { name: "be", logo: beLogo, scale: 0.95 },
...
const BRANDS_ROW_3: Brand[] = [
  ...
  { name: "RMIT University", logo: rmitLogo, scale: 0.75 },
